...
import server.spring.auth.common.filter.JwtAuthenticationFilter;
import server.spring.auth.common.security.handler.CustomAccessDeniedHandler;
import server.spring.auth.common.security.handler.CustomAuthenticationEntryPoint;
import server.spring.auth.common.security.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            .authorizeHttpRequests((requests) -> {
                requests.requestMatchers("/token/**", "/account/**").permitAll();
